...
# Load train
X_train = np.load('train_test_split/paper_title_data_X_train_wordsize_61940_max_54.npy', allow_pickle = True)
X_test = np.load('train_test_split/paper_title_data_X_test_wordsize_61940_max_54.npy', allow_pickle = True)
Y_train = np.load('train_test_split/paper_title_data_Y_train_wordsize_61940_max54.npy', allow_pickle = True)
Y_test = np.load('train_test_split/paper_title_data_Y_test_wordsize_61940_max_54.npy', allow_pickle = True)
...
model = Sequential()
model.add(Embedding(62892, 600))                                                # makes token to vector
